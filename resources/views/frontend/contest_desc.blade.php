...
<div class="card">
          <div class="card shadow-base bd-0 mg-0">
            <figure class=" rounded-top " style="width:100%;height: 350px;overflow-y: hidden;">
              <img class="img-fluid rounded-top color" src="{{asset('public/assets/uploads/contest/'.$contestDescription->image)}}" alt="Image" style="width:100%;height:100%;object-fit: cover;">
            </figure>
            <div class="card-body pd-25">
              ...
              <p class="tx-14 tx-gray-600 mg-b-25">{{$contestDescription->description}} </p>
                ...
                <a href="#" class="badge badge-warning p-2"><i class="fas fa-calendar-check fa-2x px-2"></i>{{date('d-m-Y', strtotime($contestDescription->start_date));}} </h5></a>
              

      <a href="#" class="badge badge-dark p-2"><i class="fas fa-calendar-times fa-2x px-2"></i> {{date('d-m-Y', strtotime($contestDescription->end_date));}}</a>             
               ...
               @else
             <a href="{{url('/contest-form',$contestDescription->id)}}" class="btn btn-primary my-3 btn-lg ">Participate Contest</a>
